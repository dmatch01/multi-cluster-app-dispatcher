...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RuntimeDurationSpec) DeepCopyInto(out *RuntimeDurationSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RuntimeDurationSpec.
func (in *RuntimeDurationSpec) DeepCopy() *RuntimeDurationSpec {
	if in == nil {
		return nil
	}
	out := new(RuntimeDurationSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SchedulingSpecTemplate) DeepCopyInto(out *SchedulingSpecTemplate) {
	*out = *in
	...
	out.RuntimeDuration = in.RuntimeDuration
	return
}
